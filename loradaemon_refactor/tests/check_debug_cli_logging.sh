...
require "$LOG_H" "extern DaemonLogLevel daemon_log_level" "global log level declaration"
require "$LOG_CPP" "DaemonLogLevel daemon_log_level = DAEMON_LOG_NORMAL;" "global log level definition"
require "$LOG_H" "void daemon_verbose_ctx(const char *ctx, const char *fmt, ...)" "context verbose helper declaration"
require "$LOG_CPP" "void daemon_verbose_ctx(const char *ctx, const char *fmt, ...)" "context verbose helper definition"
require "$LOG_H" "void daemon_debug_ctx(const char *ctx, const char *fmt, ...)" "context debug helper declaration"
require "$LOG_CPP" "void daemon_debug_ctx(const char *ctx, const char *fmt, ...)" "context debug helper definition"
require "$LOG_H" "void daemon_debug_band(const char *tag, const char *fmt, ...)" "band debug helper declaration"
require "$LOG_CPP" "void daemon_debug_band(const char *tag, const char *fmt, ...)" "band debug helper definition"
require "$LOG_CPP" "static void daemon_vlog_ctx(const char *ctx, const char *fmt, va_list ap)" "context prefix helper"
require "$DAEMON" "#include \"daemon_log.h\"" "daemon log helper include"
require "$BUILD" "daemon_log.cpp" "logger implementation linked"
